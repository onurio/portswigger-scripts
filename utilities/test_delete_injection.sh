...
# Test command injection in DELETE request for video ID parameter
echo "Testing command injection in DELETE /identity/api/v2/admin/videos/FUZZ"
echo "======================================================================="
